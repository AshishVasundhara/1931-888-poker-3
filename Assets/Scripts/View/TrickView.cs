...
public class TrickView : MonoBehaviour {
	...
	public void OnGameOver(){
		...
		p.transform.Find ("Avatar").GetComponent<Image> ().sprite = controller.players [0].View.Avatar.normal;
		...
		p.transform.Find ("Avatar").GetComponent<Image> ().sprite = controller.players [1].View.Avatar.normal;
		...
		p.transform.Find ("Avatar").GetComponent<Image> ().sprite = controller.players [2].View.Avatar.normal;
		...
		p.transform.Find ("Avatar").GetComponent<Image> ().sprite = controller.players [3].View.Avatar.normal;
